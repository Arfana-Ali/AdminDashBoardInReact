...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  // Note: Agar cancelled tasks ki total count chahiye to condition mein "isCancelled" lagana hoga.
...
export default function CancelledTasks() {
  ...
  // Total tasks from userTotalTasks
  ...
  if (loggedinUser && loggedinUser.role === "MODERATOR") {
    return (
      // Overall container matching the first file
      <div className="flex bg-gray-900 h-screen w-full overflow-hidden max-sm:flex-col">
